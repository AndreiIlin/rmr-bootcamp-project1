...
export default {
  translation: {
    ...
    modals: {
      ...
      approveReport: 'Принять',
      rejectReport: 'Отклонить',
      edit: 'Редактировать',
      close: 'Закрыть',
      send: 'Отправить',
    },
    ...
    toast: {
      ...
      successSendReport: 'Ваш отчет успешно отправлен',
      successChangeReport: 'Ваш отчет успешно изменён',
      reportApproved: 'Отчёт принят',
      reportRejected: 'Отчёт отклонен',
    },
    landingPage: {
    ...
    reports: {
      ...
      type: 'Тип',
      status: 'Статус',
      noReportsYet: 'В настоящий момент отчётов нет',
    },
  },
};
